...
fout = open('3layers_more_features.txt', 'w')
...
class Net():
    def __init__(self, input_shape):
        ...
        self.model.add(layers.Conv2D(45, 3, input_shape = input_shape, activation = 'relu'))
        ...
        self.model.add(layers.Conv2D(675, 3, activation = 'relu'))
        # In our example, we are now at 10 x 10 x 16.
        self.model.add(layers.MaxPooling2D(pool_size = 3, padding="same"))
        self.model.add(layers.Conv2D(10125, 3, activation = 'relu'))
